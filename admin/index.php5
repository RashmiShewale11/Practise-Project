                ...
                <div class="stat-grid p-3 mt-3 d-flex align-items-center justify-content-between bg-success">
                    ...
                    <div class="s-r">
                        <h6> <ul class="top-icons-agileits-w3layouts float-right">
                                <li class="nav-item dropdown">
                                    <?php
                                    $sql = "SELECT count(PHCid) as count1 from PHCregister where status is null ";
                                    $tot_count = $conn->query($sql);
                                    if ($tot_count->num_rows > 0) {
                                        $data = $tot_count->fetch_assoc();
                                    }
                ...
                <div class="stat-grid p-3 mt-3 d-flex align-items-center justify-content-between bg-danger">
                    ...
                    <div class="s-r">
                        <h6> <ul class="top-icons-agileits-w3layouts float-right">
                                <li class="nav-item dropdown">
                                    <?php
                                    $sql = "SELECT count(PHCid) as count1 from PHCregister where status=1";
                                    $tot_count = $conn->query($sql);
                                    if ($tot_count->num_rows > 0) {
                                        $data = $tot_count->fetch_assoc();
                                    }
                    ...
                    <div class="s-r">
                        <h6>
                            <ul class="top-icons-agileits-w3layouts float-right">
                                <li class="nav-item dropdown">
                                    <?php
                                    $sql = "SELECT count(PHCid) as count1 from PHCregister where status=0";
                                    $tot_count = $conn->query($sql);
                                    if ($tot_count->num_rows > 0) {
                                        $data = $tot_count->fetch_assoc();
                                    }
